import sys
sys.path.append("../..")
from confuzz.core.global_variables import *
from confuzz.core.main import MainEngine
from confuzz.modules.supporter.httpd import modperl_hacker, httpd_daemon
...
hd.setDaemon(False)
hd.get_event("consolefile=/confuzz-code/examples/Httpd/Results/Self-Check/1_console.txt")
