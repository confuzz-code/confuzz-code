...
from confuzz.modules.system_tester import EventListener
from confuzz.modules.system_tester import Observer
from confuzz.modules.system_tester import TestCase
...
class TestEngine( object ):
    ...
    def start_daemon(self, dir):
        from confuzz.modules.supporter.httpd.httpd_daemon import HttpdDaemon
    ...
    def convert_t_files(self):
        from confuzz.modules.supporter.httpd.modperl_hacker import convert_all_t_files
        convert_all_t_files()
