...
from confuzz.utils.file_system_utils import get_files_in_dir

INSTRUMENTATION = config.config.root_path + "/../../confuzz/modules/system_tester/perlscripts/instrumentation.pl"
