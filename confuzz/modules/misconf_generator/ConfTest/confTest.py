class ConfTest():
    ...
    def path_misconf(self, value, constraint):
        ...
        if file_or_dir == "F":
            misconfs.append( {"name": "path_dir",
                              "key": None,
                              "operator": None,
                              "value": "/confuzz/TEST_CONFUZZ"} )

        if file_or_dir == "D":
            misconfs.append( {"name": "path_file",
                              "key": None,
                              "operator": None,
                              "value": "/confuzz/TEST_CONFUZZ/ConfuzzFile2Test"} )
        return misconfs
    ...
    def prepare_test_env(self):
        import os, shutil
        if os.path.exists( "/confuzz/TEST_CONFUZZ" ):
            shutil.rmtree( "/confuzz/TEST_CONFUZZ" )
        try:
            os.makedirs( "/confuzz/TEST_CONFUZZ" )
            with open("/confuzz/TEST_CONFUZZ/ConfuzzFile2Test", 'w') as fp:
                pass
        except:
            pass
