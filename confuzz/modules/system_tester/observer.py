...
class CrashObserver( Thread ):
    ...
    def __init__(self):
        ...
        self.event = None
        # /confuzz-code/examples/Nginx/
        subprocess.Popen( "bash " + config.config.root_path + "/../../confuzz/modules/system_tester/shell/coredumpSetting.sh", shell=True )
