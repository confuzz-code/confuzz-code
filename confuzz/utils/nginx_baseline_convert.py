...
file_baseline = open("/Users/A/Desktop/baseline.txt", 'r')
file_tocompare = open("/Users/A/Desktop/1_log.txt", 'r')
...
with open("/Users/A/Desktop/baseline_new.txt", 'w') as fp_base:
    fp_base.writelines(new_baseline)
with open("/Users/A/Desktop/tocompare_new.txt", 'w') as fp_tocompare:
