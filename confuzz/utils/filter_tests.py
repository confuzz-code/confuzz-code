...
with open ("/Users/A/Desktop/confuzz/confuzz/utils/test_scripts.json", 'r') as fp:
    content1 = fp.read()
    test_scripts = json.loads(content1)

with open ("/Users/A/Desktop/confuzz/confuzz/utils/test_oracles.json", 'r') as fp:
    content2 = fp.read()
...
for i in range(252):
    ...
    if count in PASS:
        ...
        pass
with open("/Users/A/Desktop/confuzz/confuzz/utils/new_test_scripts.json", 'w') as fp1:
    with open("/Users/A/Desktop/confuzz/confuzz/utils/new_test_oracles.json", 'w') as fp2:
